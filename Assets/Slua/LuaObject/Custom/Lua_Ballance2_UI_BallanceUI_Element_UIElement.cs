...
public class Lua_Ballance2_UI_BallanceUI_Element_UIElement : LuaObject {
	...
	static public int Init(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(string),typeof(string))){
				Ballance2.UI.BallanceUI.Element.UIElement self=(Ballance2.UI.BallanceUI.Element.UIElement)checkSelf(l);
				System.String a1;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ReadAndSolveXml(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(matchType(l,argc,2,typeof(string))){
				...
				System.String a1;
				checkType(l,2,out a1);
				self.ReadAndSolveXml(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(System.Xml.XmlNode))){
				Ballance2.UI.BallanceUI.Element.UIElement self=(Ballance2.UI.BallanceUI.Element.UIElement)checkSelf(l);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function ReadAndSolveXml to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.UI.BallanceUI.Element.UIElement");
		addMember(l,Init);
		addMember(l,ReadAndSolveXml);
		...
		createTypeMetatable(l,null, typeof(Ballance2.UI.BallanceUI.Element.UIElement),typeof(UnityEngine.MonoBehaviour));
	}
}
