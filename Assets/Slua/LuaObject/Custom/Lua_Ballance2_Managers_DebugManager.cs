...
public class Lua_Ballance2_Managers_DebugManager : LuaObject {
	...
	static public int RegisterCommand(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(string),typeof(Ballance2.Managers.DebugManager.CommandDelegate),typeof(int),typeof(string))){
				Ballance2.Managers.DebugManager self=(Ballance2.Managers.DebugManager)checkSelf(l);
				System.String a1;
				checkType(l,2,out a1);
				Ballance2.Managers.DebugManager.CommandDelegate a2;
	...
	static public int get_TAG(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Ballance2.Managers.DebugManager.TAG);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.Managers.DebugManager");
		...
		createTypeMetatable(l,null, typeof(Ballance2.Managers.DebugManager),typeof(Ballance2.Managers.BaseManagerBindable));
	}
}
