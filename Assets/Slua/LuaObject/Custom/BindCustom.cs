	...
	public class BindCustom {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_Ballance2_Managers_ModBase_GameMod.reg,
				Lua_Ballance2_Managers_ModBase_GameModStatus.reg,
				Lua_Ballance2_Managers_ModBase_GameModType.reg,
				Lua_Ballance2_Managers_ModBase_GameModEntryCodeExecutionAt.reg,
				Lua_Ballance2_Managers_ModBase_GameModInfo.reg,
				Lua_Ballance2_Managers_ModBase_GameCompatibilityInfo.reg,
				Lua_Ballance2_Managers_ModBase_GameDependencyInfo.reg,
				Lua_Ballance2_Managers_CoreBridge_GameAction.reg,
				Lua_Ballance2_Managers_CoreBridge_GameActionCallResult.reg,
				Lua_Ballance2_Managers_CoreBridge_GameActionNames.reg,
