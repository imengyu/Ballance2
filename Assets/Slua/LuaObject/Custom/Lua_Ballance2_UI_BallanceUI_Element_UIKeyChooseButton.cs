...
public class Lua_Ballance2_UI_BallanceUI_Element_UIKeyChooseButton : LuaObject {
	...
	static public int SetEventHandler(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.UI.BallanceUI.Element.UIKeyChooseButton self=(Ballance2.UI.BallanceUI.Element.UIKeyChooseButton)checkSelf(l);
			System.String a1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.UI.BallanceUI.Element.UIKeyChooseButton");
		addMember(l,SetEventHandler);
		addMember(l,RemoveEventHandler);
		addMember(l,"Text",get_Text,set_Text,true);
		addMember(l,"Key",get_Key,set_Key,true);
		createTypeMetatable(l,null, typeof(Ballance2.UI.BallanceUI.Element.UIKeyChooseButton),typeof(Ballance2.UI.BallanceUI.UIElement));
	}
}
