...
public class Lua_Ballance2_UI_Utils_UIFadeManager : LuaObject {
	...
	static public int AddFadeOut(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(UnityEngine.UI.Image),typeof(float),typeof(bool))){
				Ballance2.UI.Utils.UIFadeManager self=(Ballance2.UI.Utils.UIFadeManager)checkSelf(l);
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.GameObject),typeof(float),typeof(bool),typeof(UnityEngine.Material))){
				Ballance2.UI.Utils.UIFadeManager self=(Ballance2.UI.Utils.UIFadeManager)checkSelf(l);
	...
	static public int AddFadeIn(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.GameObject),typeof(float),typeof(UnityEngine.Material))){
				Ballance2.UI.Utils.UIFadeManager self=(Ballance2.UI.Utils.UIFadeManager)checkSelf(l);
				UnityEngine.GameObject a1;
				checkType(l,2,out a1);
				System.Single a2;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.UI.Utils.UIFadeManager");
		addMember(l,AddFadeOut);
		addMember(l,AddFadeIn);
		createTypeMetatable(l,null, typeof(Ballance2.UI.Utils.UIFadeManager),typeof(UnityEngine.MonoBehaviour));
	}
}
