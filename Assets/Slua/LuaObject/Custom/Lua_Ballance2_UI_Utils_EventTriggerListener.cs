...
public class Lua_Ballance2_UI_Utils_EventTriggerListener : LuaObject {
	...
	static public int OnPointerClick(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.UI.Utils.EventTriggerListener self=(Ballance2.UI.Utils.EventTriggerListener)checkSelf(l);
	...
	static public int Get_s(IntPtr l) {
		try {
			...
			var ret=Ballance2.UI.Utils.EventTriggerListener.Get(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int set_onClick(IntPtr l) {
		try {
			...
			#endif
			Ballance2.UI.Utils.EventTriggerListener self=(Ballance2.UI.Utils.EventTriggerListener)checkSelf(l);
			Ballance2.UI.Utils.EventTriggerListener.VoidDelegate v;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.UI.Utils.EventTriggerListener");
		...
		createTypeMetatable(l,null, typeof(Ballance2.UI.Utils.EventTriggerListener),typeof(UnityEngine.EventSystems.EventTrigger));
	}
}
