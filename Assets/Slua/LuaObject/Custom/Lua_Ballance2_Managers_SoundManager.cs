...
public class Lua_Ballance2_Managers_SoundManager : LuaObject {
	...
	static public int get_TAG(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Ballance2.Managers.SoundManager.TAG);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.Managers.SoundManager");
