...
public class Lua_Ballance2_UI_BallanceUI_Element_UISlider : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_ValFormatText(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			Ballance2.UI.BallanceUI.Element.UISlider self=(Ballance2.UI.BallanceUI.Element.UISlider)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.ValFormatText);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_ValFormatText(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.UI.BallanceUI.Element.UISlider");
		addMember(l,SetEventHandler);
		addMember(l,RemoveEventHandler);
		addMember(l,"Slider",get_Slider,set_Slider,true);
		addMember(l,"Text",get_Text,set_Text,true);
		addMember(l,"ValFormatText",get_ValFormatText,set_ValFormatText,true);
		createTypeMetatable(l,null, typeof(Ballance2.UI.BallanceUI.Element.UISlider),typeof(Ballance2.UI.BallanceUI.UIElement));
	}
}
