...
public class Lua_Ballance2_Utils_StringUtils : LuaObject {
	...
	static public int isNullOrEmpty_s(IntPtr l) {
		try {
			...
			var ret=Ballance2.Utils.StringUtils.isNullOrEmpty(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int IsNullOrWhiteSpace_s(IntPtr l) {
		try {
			...
			System.String a1;
			checkType(l,1,out a1);
			var ret=Ballance2.Utils.StringUtils.IsNullOrWhiteSpace(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int TestBytesMatch_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			var ret=Ballance2.Utils.StringUtils.TestBytesMatch(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
