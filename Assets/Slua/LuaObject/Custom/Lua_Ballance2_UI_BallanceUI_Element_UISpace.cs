...
public class Lua_Ballance2_UI_BallanceUI_Element_UISpace : LuaObject {
	...
	static public int get_Height(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.UI.BallanceUI.Element.UISpace self=(Ballance2.UI.BallanceUI.Element.UISpace)checkSelf(l);
			pushValue(l,true);
