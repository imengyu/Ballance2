...
public class Lua_Ballance2_CoreBridge_Store : LuaObject {
	...
	static public int Destroy(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.CoreBridge.Store self=(Ballance2.CoreBridge.Store)checkSelf(l);
			self.Destroy();
			pushValue(l,true);
			return 1;
		}
	...
	static public int AddParameter(IntPtr l) {
		try {
			...
			Ballance2.CoreBridge.StoreDataAccess a2;
			a2 = (Ballance2.CoreBridge.StoreDataAccess)LuaDLL.luaL_checkinteger(l, 3);
			Ballance2.CoreBridge.StoreDataType a3;
			a3 = (Ballance2.CoreBridge.StoreDataType)LuaDLL.luaL_checkinteger(l, 4);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.CoreBridge.Store");
		addMember(l,Destroy);
		...
		createTypeMetatable(l,null, typeof(Ballance2.CoreBridge.Store));
	}
}
