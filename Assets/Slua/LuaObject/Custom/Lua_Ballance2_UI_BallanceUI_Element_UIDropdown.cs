...
public class Lua_Ballance2_UI_BallanceUI_Element_UIDropdown : LuaObject {
	...
	static public int SetEventHandler(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.UI.BallanceUI.Element.UIDropdown self=(Ballance2.UI.BallanceUI.Element.UIDropdown)checkSelf(l);
			System.String a1;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int AddOption(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.UI.BallanceUI.Element.UIDropdown");
		addMember(l,SetEventHandler);
		addMember(l,RemoveEventHandler);
		addMember(l,AddOption);
		addMember(l,"Dropdown",get_Dropdown,set_Dropdown,true);
		addMember(l,"Text",get_Text,set_Text,true);
		createTypeMetatable(l,null, typeof(Ballance2.UI.BallanceUI.Element.UIDropdown),typeof(Ballance2.UI.BallanceUI.UIElement));
	}
}
