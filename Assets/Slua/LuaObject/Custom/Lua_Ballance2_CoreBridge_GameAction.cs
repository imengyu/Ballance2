...
public class Lua_Ballance2_CoreBridge_GameAction : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			o=new Ballance2.CoreBridge.GameAction(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_GameHandler(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_CallTypeCheck(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			Ballance2.CoreBridge.GameAction self=(Ballance2.CoreBridge.GameAction)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.CallTypeCheck);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Empty(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Ballance2.CoreBridge.GameAction.Empty);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"CallTypeCheck",get_CallTypeCheck,null,true);
