...
public class Lua_Ballance2_UI_BallanceUI_Element_UIText : LuaObject {
	...
	static public int get_Text(IntPtr l) {
		try {
			...
			#endif
			#endif
			Ballance2.UI.BallanceUI.Element.UIText self=(Ballance2.UI.BallanceUI.Element.UIText)checkSelf(l);
			pushValue(l,true);
