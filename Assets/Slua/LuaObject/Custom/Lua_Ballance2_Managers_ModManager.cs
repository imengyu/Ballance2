...
public class Lua_Ballance2_Managers_ModManager : LuaObject {
	...
	static public int UnLoadGameMod(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(Ballance2.Managers.CoreBridge.GameMod))){
				Ballance2.Managers.ModManager self=(Ballance2.Managers.ModManager)checkSelf(l);
				Ballance2.Managers.CoreBridge.GameMod a1;
				checkType(l,2,out a1);
				var ret=self.UnLoadGameMod(a1);
				pushValue(l,true);
				pushValue(l,ret);
	...
	static public int get_TAG(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Ballance2.Managers.ModManager.TAG);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Ballance2.Managers.ModManager");
		...
		createTypeMetatable(l,null, typeof(Ballance2.Managers.ModManager),typeof(Ballance2.Managers.BaseManagerBindable));
	}
}
